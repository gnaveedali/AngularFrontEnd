...
using System.Text;
using static Standard_Trading_API.Model.SupplierDataType;
...
namespace Standard_Trading_API.Controllers
{
    ...
    public class SupplierController : Controller
    {
        ...
        public ActionResult GetSupplier()
        {
            ...
            SqlCommand com = new SqlCommand("SP_GetSupplier");
        ...
        {
            var SupplierID = DBEntity.getField("select isnull(max(Supplier_ID),0)+1 from Suppliers oder");
            return Ok(SupplierID);
        }

        [HttpPost]
        public IActionResult SaveMaster([FromBody] Supplier Instance)
        {
            try
            {
                ...
                if (Instance.addorEdit == "Add")
                {
                    ...
                    {
                        ControlCode = DBEntity.getField("select Parameter_Value from sys_Parms where Parameter_Name = 'Supplier Control Code'").ToString();
                        ...
                        com.Parameters.AddWithValue("@AccountName", Instance.supplierName + " , " + Instance.cityName);
                ...
                else
                {
                    ...
                    SqlCommand com1 = new SqlCommand("sp_AddSupplier");
                    com1.Parameters.AddWithValue("@SupplierId", Instance.supplierId);
                    com1.Parameters.AddWithValue("@SupplierName", Instance.supplierName);
        ...
        [HttpPost]
        public ActionResult DeleteSupplier([FromBody] Supplier Instance)
        {
            msg = string.Empty;
            sSQL = string.Empty;
            ...
            try
            {
                ...
                string customer = DBEntity.getField("Select PhotoPath from Suppliers where Supplier_ID =" + Instance.supplierId + " ").ToString();
                ...
                DBEntity.ExecuteNonQuery("Delete from Suppliers where Supplier_ID =" + Instance.supplierId + " ", out msg);
